package com.cloud.vblog.auth.generator;
...
//		//============================== 全局配置
		...
		gc.setOutputDir(projectPath + "/vblog_authority/src/main/java")
				.setActiveRecord(true)// 是否支持 AR
				.setAuthor("aiwei") //设置作者名字
		...
		dsc.setDbType(DbType.MYSQL)
				.setUrl("jdbc:mysql://127.0.0.1:3306/vblog?characterEncoding=utf-8&useSSL=false&useUnicode=true&serverTimezone=GMT%2B8")
		...
		pc.setParent("com.cloud.vblog.auth")//配置父包路径
		...
		focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
			...
			public String outputFile(TableInfo tableInfo) {
				// 自定义输入文件名称
				return projectPath + "/vblog_authority/src/main/resources/mybatis/"
...
//				.setTemplateEngine(new FreemarkerTemplateEngine());
	...
	public static void main(String[] args) {
		Generator(new String[]{"t_category_menu","t_role","t_user","t_user_role"});
	}
}